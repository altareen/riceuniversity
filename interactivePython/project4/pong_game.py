...
| Author:   Alwin Tareen
| Created:  Jun 26, 2015
| Execute:  python3 pong_game.py
|
| This program implements the pong game.
|
| Codeskulptor link:
| https://py2.codeskulptor.org/#user40_bKhrkQuaws_10.py
|
"""
...
def draw(canvas):
    ...
    canvas.draw_text(str(score2), (WIDTH*0.75, HEIGHT/4), 60, "White")
